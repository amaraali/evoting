...
if (isset($_GET["id"])) {
  ...
  $edit = true;
  $id = $_GET["id"];
  $baris = query("SELECT * FROM calon WHERE id = $id");
  if (count($baris)  == 1) {
    $data = $baris[0];
  } else {
    ...
    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-10 ">
      <form class="needs-validation" method="post" action="../../actions/action_calon.php" novalidate>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="nama_ketua" name="nama_ketua" autocomplete="off" required value="<?php if ($edit) : echo $data["nama_ketua"];
                                                                                                                        endif; ?>">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="nama_wakil" name="nama_wakil" autocomplete="off" required value="<?php if ($edit) : echo $data["nama_wakil"];
                                                                                                                        endif; ?>">
          <div class="invalid-feedback">
            Kolom ini tidak boleh kososng.
          </div>
